...
export default function Tab() {
    return (
        <ScrollView contentInsetAdjustmentBehavior={"automatic"}>
            ...
            <View style={{ ...styles.row_containerGenre }}>
                <RecipeBox
                    imagePath="https://hips.hearstapps.com/hmg-prod/images/soba-royalty-free-image-1621288461."
                    textRecipe="East Asian"
                />
                <RecipeBox
                    imagePath="https://springsmag.com/wp-content/uploads/2017/03/Tacos-1-696x464.png"
                    textRecipe="Mexican"
                />
            </View>
        </ScrollView>
