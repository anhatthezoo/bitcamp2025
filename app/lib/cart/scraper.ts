...
//   await page.waitForSelector('span.e-6n7j50');
// // //   // Set screen size
...
//   for(const element of $('li.e-14qbqkc span.e-6gqwm0')) {
//     console.log($(element).text());
//   }
//   for(const element2 of $('span.e-6n7j50')) {
//     console.log("hi")
//     console.log($(element2).text());
//   }
//   // $('li.e-14qbqkc').map((elem: any) => {
//   //   console.log("hi");
//   //   // console.log($(elem).find('span.e-6gqwm0').text());
//   // })
// }
// )